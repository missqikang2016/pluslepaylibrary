package com.lechinepay.pluslepay.sdk.view;

/**
 * 实现：日期选择类
 * 作者：thomson King on 2016/8/16 0016 11:06
 ...
 * </p>
 */
public class DataPickerDialogView extends AlertDialog implements OnClickListener, OnDateChangedListener {
...
//    private final DatePicker mDatePicker_end;
     ...
     */
    public DataPickerDialogView(Context context, OnDateSetListener callBack, int year, int monthOfYear, int dayOfMonth) {
        this(context, 0, callBack, year, monthOfYear, dayOfMonth);
    }

    public DataPickerDialogView(Context context, int theme, OnDateSetListener callBack, int year, int monthOfYear,
                                int dayOfMonth) {
    ...
    public DataPickerDialogView(Context context, int theme, OnDateSetListener callBack, int year, int monthOfYear,
        ...
        View view = inflater.inflate(R.layout.lepay_data_picker_dialog, null);
        setView(view);
...
//            LePayLogTool.i(datePickerField.getName());
//            if ("false".equals(datePickerField.getName())) {
